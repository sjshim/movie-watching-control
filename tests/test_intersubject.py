...
#     data = pytest.correlated_timeseries(20, 60, noise=.5,
#                                  random_state=42)
#     iscs = isc(data, pairwise=False)
#     observed, ci, p, distribution = bootstrap_isc(iscs, pairwise=False)
...
#     data = np.dstack((pytest.simulated_timeseries(10, n_TRs, n_voxels=n_voxels,
#                                            noise=1, data_type='array',
#                                            random_state=3),
#                       pytest.simulated_timeseries(10, n_TRs, n_voxels=n_voxels,
...
#     data_1 = pytest.simulated_timeseries(10, n_TRs, n_voxels=n_voxels,
#                                   noise=1, data_type='array',
#                                   random_state=3)
#     data_2 = pytest.simulated_timeseries(10, n_TRs, n_voxels=n_voxels,
...
#     data = pytest.simulated_timeseries(12, n_TRs,
#                                 n_voxels=n_voxels, data_type='array',
#                                 random_state=random_state)
#     iscs = isc(data, pairwise=False, summary_statistic=None)
...
#     data = np.dstack((pytest.simulated_timeseries(3, n_TRs, n_voxels=n_voxels,
#                                            noise=1, data_type='array',
#                                            random_state=3),
#                       pytest.simulated_timeseries(4, n_TRs, n_voxels=n_voxels,
...
#     data_1 = pytest.simulated_timeseries(3, n_TRs, n_voxels=n_voxels,
#                                   noise=1, data_type='array',
#                                   random_state=3)
#     data_2 = pytest.simulated_timeseries(4, n_TRs, n_voxels=n_voxels,
#                                   noise=50, data_type='array',
#                                   random_state=4)
#     iscs = np.vstack((isc(data_1, pairwise=False, summary_statistic=None),
#                       isc(data_2, pairwise=False, summary_statistic=None)))
...
#                                 n_voxels=n_voxels, data_type='array')
#     n_targets = 15
#     targets_data = pytest.simulated_timeseries(n_subjects, n_TRs,
#                                         n_voxels=n_targets,
#                                         data_type='array')
